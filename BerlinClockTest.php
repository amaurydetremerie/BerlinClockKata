...
class BerlinClockTest extends TestCase
{
    ...
    private function time_hour(string $time): string
    {
        return $this->berlinClock->time_to_hours($time);
    }
    ...
    public function test_time_to_minute_given59_shouldReturn_2y1r2y1r2y1r2y_CR_4y(){
        $actual = $this->time_minutes("00-59-00");

        $this->assertEquals("yyryyryyryy\nyyyy", $actual);
    }

    public function test_time_to_hours_given00_shouldReturn_4x_CR_4x(){
        $actual = $this->time_hour("00-00-00");

        $this->assertEquals("xxxx\nxxxx", $actual);
    }

    public function test_time_to_hours_given23_shouldReturn_4r_CR_3r1x(){
        $actual = $this->time_hour("23-00-00");
