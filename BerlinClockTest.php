...
class BerlinClockTest extends TestCase
{
    ...
    public function test_5minute_given15minute_shouldReturn2y1r8x(){
        $actual = $this->five_minutes(15);

        $this->assertEquals("yyrxxxxxxxx",$actual);
    }

    public function test_5minute_given20minute_shouldReturn2y1r1y7x(){
        $actual = $this->five_minutes(20);

        $this->assertEquals("yyryxxxxxxx",$actual);
    }

    public function test_5minute_given25minute_shouldReturn2y1r2y6x(){
        $actual = $this->five_minutes(25);

        $this->assertEquals("yyryyxxxxxx",$actual);
    }

    public function test_5minute_given30minute_shouldReturn2y1r2y1r5x(){
        $actual = $this->five_minutes(30);

        $this->assertEquals("yyryyrxxxxx",$actual);
    }

    public function test_5minute_given55minute_shouldReturn2y1r2y1r2y1r2y(){
